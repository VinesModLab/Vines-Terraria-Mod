...
namespace VinesMod.Items.Weapons.Melee
{
	public class GrassDefender : ModItem
	{
		...
		{
			Projectile.NewProjectile(source, position, velocity, type, (int)(damage * 0.55f), knockBack, player.whoAmI, 3f);
			return false;
		}
		...
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddIngredient(ModContent.ItemType<global::VinesMod.Items.Materials.Shards.ShardGreen>(), 5)
